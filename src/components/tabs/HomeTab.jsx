...
const features = [
  {
    ...
    description: 'Todos nuestros cuidadores pasan por un riguroso proceso de verificación',
  ...
  },
  {
    ...
    description: 'Servicios adaptados a las necesidades específicas de tu mascota',
...
export default function HomeTab({ onFindWalkerClick }) {
  ...
  return (
    ...
    >
      {/* Carrusel */}
      <section className="relative h-[500px] md:h-[600px] min-h-[400px] overflow-hidden rounded-3xl">
        ...
        <button
          onClick={prevSlide}
          aria-label="Anterior"
          className="absolute z-20 left-4 top-1/2 -translate-y-1/2 bg-black/30 hover:bg-black/50 text-white p-2 rounded-full transition focus:outline-none"
        >
          <ChevronLeft size={28} />
        </button>
        <button
          ...
          className="absolute z-20 right-4 top-1/2 -translate-y-1/2 bg-black/30 hover:bg-black/50 text-white p-2 rounded-full transition focus:outline-none"
        >
